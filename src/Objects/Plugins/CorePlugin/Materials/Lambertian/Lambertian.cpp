...
namespace RayTracer
{
    ...
    {
        constexpr float u1 = 0.5f; // ADDED THESES FLOATS SINCE THE SAMPLE FUNCTION IS NOW DETERMINISTIC, WE CAN USE FIXED VALUES FOR u1 AND u2
        constexpr float u2 = 0.5f;
        constexpr float phi = 2.0f * M_PI * u1;
